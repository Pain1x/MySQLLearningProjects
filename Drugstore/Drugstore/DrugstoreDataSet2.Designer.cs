...
namespace Drugstore {
    ...
    public partial class DrugstoreDataSet2 : global::System.Data.DataSet {
        ...
        public partial class SoldDataTable : global::System.Data.TypedTableBase<SoldRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SoldRow AddSoldRow(string Name, decimal Price, int Quantity, System.DateTime Date) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SoldRow FindByID(int ID) {
        ...
        public partial class SoldRow : global::System.Data.DataRow {
            ...
            public int ID {
                get {
                    return ((int)(this[this.tableSold.IDColumn]));
                }
                set {
                    this[this.tableSold.IDColumn] = value;
                }
            }
            ...
            public string Name {
                get {
                    return ((string)(this[this.tableSold.NameColumn]));
                }
                set {
                    this[this.tableSold.NameColumn] = value;
                }
            }
...
namespace Drugstore.DrugstoreDataSet2TableAdapters {
    ...
    public partial class SoldTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Sold] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Nam" +
                "e) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity) AND ([D" +
                "ate] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sold] ([Name], [Price], [Quantity], [Date]) VALUES (@Name, @Pr" +
                "ice, @Quantity, @Date);\r\nSELECT ID, Name, Price, Quantity, Date FROM Sold WHERE " +
                "(ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sold] SET [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity, [Date] = @Date WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity) AND ([Date] = @Original_Date));
SELECT ID, Name, Price, Quantity, Date FROM Sold WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Price, Quantity, Date FROM dbo.Sold";
        ...
        public virtual int Fill(DrugstoreDataSet2.SoldDataTable dataTable) {
        ...
        public virtual DrugstoreDataSet2.SoldDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DrugstoreDataSet2.SoldDataTable dataTable = new DrugstoreDataSet2.SoldDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DrugstoreDataSet2.SoldDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, decimal Original_Price, int Original_Quantity, System.DateTime Original_Date) {
        ...
        public virtual int Insert(string Name, decimal Price, int Quantity, System.DateTime Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, decimal Price, int Quantity, System.DateTime Date, int Original_ID, string Original_Name, decimal Original_Price, int Original_Quantity, System.DateTime Original_Date, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, int Quantity, System.DateTime Date, int Original_ID, string Original_Name, decimal Original_Price, int Original_Quantity, System.DateTime Original_Date) {
            return this.Update(Name, Price, Quantity, Date, Original_ID, Original_Name, Original_Price, Original_Quantity, Original_Date, Original_ID);
        }
    }
